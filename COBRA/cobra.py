...
if __name__ == "__main__":
    df_claim = pd.read_csv("COBRA/insurance.csv")
    ...
    COBRA.optimal_threshold(num_grid_points=50)
    
    print("Optimal Epsilon = ",COBRA.eps)

    y_pred = COBRA.predict(X_test)
    print("RMSE = ", COBRA.calculate_RMSE(y_pred, y_test))
    print("R^2 error = ", COBRA.calculate_R_square(y_pred, y_test))